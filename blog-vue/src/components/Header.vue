<template>
	...
	<div class="m-content">
		...
		<div class="nav-left">
			<el-image style="width: 60px; height: 60px;margin-top: 18px" :src="url" lazy>
			</el-image>
		</div>
		<div class="nav-right">
		...
		<div class="block">
			...
			<div class="m-action">
				...
				<el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal">
					...
					<el-menu-item index="1">
						<el-link type="warning" @click="toUser">我的文章</el-link>
					</el-menu-item>
	...
	export default {
		data() {
			return {
				...
				isLogin: false,
				url: "https://an23.co/upload/2022/07/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20220722020131.jpg"
			};
		},
		methods: {
			logout() {
